        ...
        for epoch in range(current_epoch+1, MAX_EPOCHS+1, 1):
            ...
            for t in range(1000):
                ...
                if EXPLORE is True: #explore
                    ...
                    if np.sum(np.array(pose_new) - np.array(pose_prev)) < 0.1:
                        same_image_penalty = -4.0
                    else:
                        same_image_penalty = 0.0
                    #print('action', action)
                    # print('action env', action_env)
                    ...
                    reward = reward_i*BATCH_SIZE*100  + same_image_penalty
