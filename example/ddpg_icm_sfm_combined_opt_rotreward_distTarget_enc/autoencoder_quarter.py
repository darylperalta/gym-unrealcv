...
def dataloader(batch_size =32,vae = False, dataset_path = '/home/daryl/datasets/unreal_images',test_path='/home/daryl/datasets/unreal_images_test', img_rows = 240,img_cols = 320,channels=1,augment=True):
    # print('dataloader')
    imageSet = glob(dataset_path+'/*.png')
    # imageSet.sort()
    # print(imageSet[0:10])
...
def test_load(batch_size =32,dataset_path = '/home/daryl/datasets/unreal_images',test_path='/home/daryl/datasets/unreal_images_test', img_rows = 240,img_cols = 320, channels= 1, test=False):
    imageSet = glob(test_path+'/*.png')
    random.shuffle(imageSet)
