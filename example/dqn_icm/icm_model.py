...
class icm_class(object):
    def __init__(self, state_shape, action_size, enc_shape, LEARNING_RATE, pretrained=False, enc_path = '/hdd/AIRSCAN/icm_models/encoder_checkpointsmodel-50_cont.hdf5', vae =True):
        # self.sess = sess
        # self.TAU = TAU
